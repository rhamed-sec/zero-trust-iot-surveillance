 ...
 **تطبيق العزل الشبكي الصارم (Strict IoT VLAN):**
 ...
 **الوصول عن بُعد حصراً عبر أنفاق مشفرة حقيقية (WireGuard / Tailscale):**
 ...
 **الاعتماد على المسجلات المحلية الذكية ومفتوحة المصدر (Frigate Local AI):**
 ...
 **إلزامية التحديثات الموقعة رقمياً وتغيير المنافذ الافتراضية:**
